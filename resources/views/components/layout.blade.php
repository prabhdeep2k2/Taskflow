    ...
    <aside class="relative bg-blue-600 w-54 shadow-xl">
        <div class="p-6">
            <a href="{{ route('task.index') }}"
                class="text-white text-3xl font-semibold uppercase hover:text-gray-300" style="padding-bottom: 20px;">
                <img src="https://logowik.com/content/uploads/images/t_google-tasks7052.logowik.com.webp" style="padding-bottom: 10px;">
                TaskFlow
            </a>
            <button
